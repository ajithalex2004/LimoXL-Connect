...
-- Drop existing role constraint if it exists and recreate with SUPER_ADMIN
ALTER TABLE users DROP CONSTRAINT IF EXISTS users_role_check;
ALTER TABLE users ADD CONSTRAINT users_role_check CHECK (role IN ('ADMIN', 'OPS', 'SUPPLIER_ADMIN', 'DISPATCHER', 'PARTNER', 'SUPER_ADMIN'));
